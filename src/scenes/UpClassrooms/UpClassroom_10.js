...
export default async function upClassroom_10(k) {
  colorizeBackground(k, 58, 58, 80);

  const mapData = await fetchMapData("./assets/maps/salonArriba10.json");
  ...
  entities.player.onCollide("classroom - exit", () => {
    ...
    gameState.setPreviousScene("UpClassroom_10");
    k.go("groundFloor");
  });
