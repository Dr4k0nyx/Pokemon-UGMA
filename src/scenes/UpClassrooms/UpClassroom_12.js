...
export default async function upClassroom_12(k) {
  colorizeBackground(k, 58, 58, 80);

  const mapData = await fetchMapData("./assets/maps/salonArriba12.json");
  ...
  entities.player.onCollide("classroom - exit", () => {
    ...
    gameState.setPreviousScene("UpClassroom_12");
    k.go("groundFloor");
  });
