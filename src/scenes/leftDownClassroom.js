...
export default async function leftDownClassroom(k) {
  colorizeBackground(k, 58, 58, 80);

  const mapData = await fetchMapData("./assets/maps/salonAbajoIzq.json");
  ...
  entities.player.onCollide("leftDownClassroom - exit", () => {
    gameState.setPreviousScene("leftDownClassroom");
    k.go("world");
  });
