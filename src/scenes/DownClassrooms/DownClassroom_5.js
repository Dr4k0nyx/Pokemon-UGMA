...
export default async function downClassroom_5(k) {
  colorizeBackground(k, 58, 58, 80);

  const mapData = await fetchMapData("./assets/maps/salonAbajo5.json");
  ...
  entities.player.onCollide("classroom - exit", () => {
    gameState.setPreviousScene("DownClassroom_5");
    k.go("firstFloor");
  });
