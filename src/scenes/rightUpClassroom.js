...
export default async function rightUpClassroom(k) {
  colorizeBackground(k, 58, 58, 80);

  const mapData = await fetchMapData("./assets/maps/salonArribaDer.json");
  ...
  entities.player.onCollide("rightUpClassroom - exit", () => {
    gameState.setPreviousScene("rightUpClassroom");
    k.go("world");
  });
