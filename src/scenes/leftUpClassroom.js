...
export default async function leftUpClassroom(k) {
  colorizeBackground(k, 58, 58, 80);

  const mapData = await fetchMapData("./assets/maps/salonArribaIzq.json");
  ...
  entities.player.onCollide("leftUpClassroom - exit", () => {
    gameState.setPreviousScene("leftUpClassroom");
    k.go("world");
  });
